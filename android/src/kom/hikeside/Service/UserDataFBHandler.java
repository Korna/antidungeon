...
import kom.hikeside.Models.Atom.UserData;
...
public class UserDataFBHandler {
    ...
    public ArrayList<Quest> getQuest(){
        ...
        ref.child(uid).child(FB_DIRECTORY_USER_DATA).child(FB_DIRECTORY_QUESTS).addListenerForSingleValueEvent(//глобальный и постоянный прослушиватель всех данных marks
                new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {

                        String s = dataSnapshot.getValue(String.class);
                        questArrayList.add(new Quest("webkey", s, "ses", false));
