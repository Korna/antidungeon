...
public class StatsFragment extends Fragment {
    ...
    @Bind(R.id.textView_strength)
    TextView textView_strength;
    @Bind(R.id.textView_agility)
    TextView textView_agility;
    @Bind(R.id.textView_intelligence)
    TextView textView_intelligence;
    @Bind(R.id.textView_stamina)
    TextView textView_stamina;
    @Bind(R.id.textView_luck)
    TextView textView_luck;
    @Bind(R.id.textView_will)
    TextView textView_will;
    @Bind(R.id.textView_name)
    TextView textView_name;
    @Bind(R.id.textView_lvl)
